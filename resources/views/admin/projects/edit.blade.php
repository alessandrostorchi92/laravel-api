        ...
        <form action="{{ route('admin.projects.update', $project->slug) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <label for="title" class="form-label fw-medium">Titolo</label><input type="text"
                    ...
                    placeholder="Inserisci il titolo del nuovo progetto" name="title"
            ...
            <div class="mb-4">
                ...
                <label for="thumb" class="form-label fw-medium">Copertina</label><input type="text" id="thumb"
                    ...
                    placeholder="Inserisci l'immagine di copertina del fumetto" name="thumb"
            ...
            <div class="mb-4">
                ...
                @enderror"
                    id="language" name="language" value="{{ old('language', $project->language) }}">
